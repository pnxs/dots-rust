...
impl Payload {
    ...
    /// See [`dots_rs_core::AnyStruct::merge_take`] /
    /// [`dots_rs_core::DynamicStruct::merge_take`] for the semantics.
    ///
...
impl Transmittable for Payload {
    ...
    ) -> Result<(), dots_rs_core::EncodeError> {
        match self {
...
pub fn encode_transmission_with_mask_into(
    ...
    let mut encoder = dots_rs_core::minicbor::Encoder::new(&mut *out);
    payload
...
impl Transmission {
    ...
    pub fn decode(bytes: &[u8], registry: &Registry) -> Result<(Self, usize), FramingError> {
        ...
        let mut decoder = dots_rs_core::minicbor::Decoder::new(body);
