...
pub enum FromAnyError {
    ...
    /// descriptor.
    Decode(dots_rs_core::DecodeError),
}
...
impl Registry {
    ...
    /// while iterating.
    pub fn iter_structs(&self) -> Vec<Arc<dots_rs_core::DynamicStructDescriptor>> {
        self.entries
            .read()
            .expect("registry poisoned")
            .values()
    ...
    pub fn iter_enums(&self) -> Vec<Arc<dots_rs_core::DynamicEnumDescriptor>> {
        self.entries
            .read()
            .expect("registry poisoned")
            .values()
...
mod from_any_tests {
    use super::*;
    use dots_rs_core::{Transmittable, to_any};
    ...
    struct Envelope {
        ...
        id: Option<u32>,
        #[dots(tag = 2)]
        payload: Option<dots_rs_core::AnyObject>,
    }

    fn envelope_wrapping(ping: &Ping) -> dots_rs_core::DynamicStruct {
        let envelope = Envelope {
            id: Some(1),
            payload: Some(to_any(ping)),
        };
        dots_rs_core::DynamicStruct::from_struct_value(&envelope)
    }
    ...
    fn from_any_dynamic_when_only_dynamic_registered() {
        ...
        let dyn_desc = std::sync::Arc::new(dots_rs_core::DynamicStructDescriptor::from_static(
            Ping::DESCRIPTOR,
        ));
    ...
    fn from_any_unknown_type_errors() {
        let registry = Registry::new();
        let any = dots_rs_core::AnyObject::new("NotRegistered", vec![0xA0]);
