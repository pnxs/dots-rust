...
use dots_rs_core::{DynamicStruct, PropertySet, Timepoint, decode_typed_from_slice, encode_to_vec};
use dots_rs_model::{
...
fn connection_state_roundtrip_each_variant() {
    ...
    for state in [
        ...
        let mut d = dots_rs_core::minicbor::Decoder::new(&buf);
...
fn handshake_descriptors_resolve_through_registry_from_wire() {
    ...
    for static_desc in [
        ...
        dots_rs_model::DotsServerCapabilities::DESCRIPTOR,
