...
/// `dots_rs_transport::global` singleton. Each test acquires this at the
...
use dots_rs_core::{StructValue, decode_typed_from_slice, dots, encode_to_vec};
...
use dots_rs_transport::{App, TransmissionCodec};
