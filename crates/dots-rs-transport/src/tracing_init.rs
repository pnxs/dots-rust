...
const LIB_CAPS: &str =
    "dots_rs_core=warn,dots_rs_derive=warn,dots_rs_model=warn,dots_rs_transport=warn";
...
///     // dots_rs_transport::init_tracing("my_app::sync=debug");
/// }
/// ```
///
/// Override at runtime:
///
/// ```text
/// RUST_LOG=dots_rs_transport=debug,my_app=trace cargo run ...
/// ```
